...
simulation data with Rucio [here](https://eic.github.io/tutorial-file-access/).  We suggest using a file with an enhanced rete of
of $J/\psi$.  For example, you can run the following command in the eic-shell:
